...
//		http
//		.authorizeRequests()
//		.antMatchers("/static/**", "/css/**", "/js/**", "/registration", "/shows/**")
//		.permitAll()
//		.antMatchers("/admin/**")
...
//      http.headers().frameOptions().disable();
		http
 		...
 		.permitAll() //se configura la ruta login para ser accedida sin autenticacion "/registration", "/shows/**", "/home", "redirect::/shows"
 		.anyRequest()
